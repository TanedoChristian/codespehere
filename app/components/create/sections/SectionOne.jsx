export default function SectionOne() {
  return (
    <section className="w-full">
      <h1 className="text-5xl font-bold text-center mt-10">Our Features</h1>
      <section className="relative xl:mr-0 lg:mr-5 mr-0  p-10">
        <div className="w-full max-w-7xl mx-auto  ">
          <div className="w-full justify-start items-center xl:gap-12 gap-10 grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="w-full lg:justify-start justify-center items-start flex h-full">
              <img
                className=" w-full     object-cover"
                src="https://management.org/wp-content/uploads/2022/01/Top-view-of-website-builders-scaled.jpg"
                alt="about Us image"
              />
            </div>
          </div>
